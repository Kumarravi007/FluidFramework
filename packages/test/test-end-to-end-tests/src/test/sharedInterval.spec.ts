...
describeFullCompat("SharedInterval", (getTestObjectProvider) => {
    ...
    describe("one client", () => {
        ...
        beforeEach(async () => {
            ...
            testIntervalOperations(intervalCollection);
        });
    ...
    describe("multiple clients", () => {
        it("propagates", async () => {
            ...
            const collection1 = sharedString1.getIntervalCollection("intervals");
            const intervals1 = await collection1.getView();
            testIntervalOperations(collection1);
